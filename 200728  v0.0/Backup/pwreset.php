	 		...
	 		<div id="page_2" >
			    <form class="needs-validation">
			    	...
			    	<div class="input-group form-group">
						...
						<input id="username" type="text" class="form-control" placeholder="請輸入帳號(手機號碼)">
					...
					<div class="input-group form-group">
						<button id="btn_back" class="btn btn-success mr-1">返回</button>
						<button id="btn_register" class="btn btn-success ml-1">送出</button>
					</div>
			    </form>
			</div>
		  </div>
