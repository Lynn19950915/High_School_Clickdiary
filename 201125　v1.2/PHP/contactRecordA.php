<?php
    ...
    if(isset($_POST["A0"])){
        ...
        if($A4>23 or $A4<0 or floor($A4)-$A4!=0){
            ...
            if(count($A0M)==1){
                $sql2="INSERT INTO `record`(id, time, `groups`, tagged, A0, A1, A2, A3, A4, A5, A6, A7, A8, A9) VALUES(:v1, CURTIME(), 0, 0, :A0, :A1, :A2, :A3, :A4, :A5, :A6, :A7, :A8, :A9)";
                ...
                $i=0;
                while($i<count($A0M)){
                    $sql4="INSERT INTO `record`(id, time, `groups`, tagged, A0, A1, A2, A3, A4, A5, A6, A7, A8, A9) VALUES(:v1, CURTIME(), 1, 0, :A0, :A1, :A2, :A3, :A4, :A5, :A6, :A7, :A8, :A9)";
                    ...
                    $sql5="INSERT INTO `record`(id, time, `groups`, tagged, A0, A1, A2, A3, A4, A5, A6, A7, A8, A9) VALUES(:v1, CURTIME(), 1, 1, :A0, :A1, :A2, :A3, :A4, :A5, :A6)";
                    $stmt=$db->prepare($sql5);
                    $stmt->bindParam(":v1", $A0M[i]);
                    $stmt->bindParam(":A0", $id);
                    $stmt->bindParam(":A1", $A1);
                    $stmt->bindParam(":A2", $A2);
                    $stmt->bindParam(":A3", $A3);
        ...
        <div class="modal-content" style="width: 100%; margin: 10px auto">
            ...
            <div class="modal-body">
                <fieldset data-role="controlgroup" data-type="horizontal">
                    ...
                    <label style="width: 20%"><input type="radio" name="A2" value="自己以外的互動成員">自己以外的互動成員</label>
        ...
        <div class="modal-content" style="width: 100%; margin: 10px auto">
            ...
            <div class="modal-body" id="A6">
                <select class="std" name="A6">
                    ...
                    <option value="其他互動對象住處／家裡">其他互動對象住處／家裡</option>
