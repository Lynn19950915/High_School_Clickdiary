...
<body>
    ...
    <div class="modal-content">
        <div class="modal-header">
            <div class="modal-title"><b>4. 我昨天忘記填寫生活日記／接觸記錄了，請問現在還能夠補填嗎？</b></div>
        </div>
        <div class="modal-body">
            <p>不可以。考量超過一天後人們不容易回憶心情與接觸細節，<b>點日記目前僅開放參與者填寫「當日」之接觸紀錄</b>（你可在當日內針對新增內容進行修改），我們建議你填寫時間以每日睡前為主。另外，若你想回溯先前的填答記錄，可點擊日記牆右方之「日曆選單」，方能進行回顧查看。</p>
        </div>
    </div>
   
    <div class="modal-content">
        <div class="modal-header">
            <div class="modal-title"><b>5. 要如何查看自己獲得多少補助金呢？</b></div>
        </div>
        <div class="modal-body">
            <p>你可以在帳號管理的「<a href="./myPoint.php">我的積分</a>」查看完整明細，除了任務專區會載明各項任務可獲得的補助金額，本團隊也會斟酌參與者日記牆（生活日記、接觸記錄）的填寫狀況，進行「日記牆獎勵」的月度評級審核，完整的獎勵政策可以參見<a href="./aboutUs.php">補助細則</a>。</p>            
        </div>
    </div>  
        
    <div class="modal-content">
        <div class="modal-header">
            <div class="modal-title"><b>6. 請問何時會收到研究補助金呢？是否需提供任何資料？</b></div>
        </div>
        <div class="modal-body">
