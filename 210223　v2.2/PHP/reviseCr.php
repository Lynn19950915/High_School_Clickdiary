<?php
    ...
    if(isset($_POST["00"])){
        ...
        if($B!="0"){
            $sql10="UPDATE `record` SET B= :v1 WHERE recordId= :v2";
        ...
        <div class="ctContent">       
            ...
            <div class="ctRecord">
                ...
                <div style="background-color: red; color: white; font-weight: bold">
                    <div id="ctQuestion">A7. 這次互動後，我的心情：</div>
                ...
                <div style="background-color: red; color: white; font-weight: bold">
                    <div id="ctQuestion">A8. 跟互動前比起來，我的心情變得：</div>
                ...
                <div style="background-color: red; color: white; font-weight: bold">
                    <div id="ctQuestion">A9. 這次互動過程中，我覺得我有具體的收穫：</div>
                ...
                <div style="background-color: red; color: white; font-weight: bold; -webkit-border-radius: 0 0 10px 10px; border-radius: 0 0 10px 10px;">
                    <div id="ctQuestion">B. 這次互動後，我認為 <?=$_SESSION["ctRecord"]["id"][-2]?><?=$_SESSION["ctRecord"]["id"][-1]?>號<?=$_SESSION["ctRecord"]["name"]?> 的心情：</div>
