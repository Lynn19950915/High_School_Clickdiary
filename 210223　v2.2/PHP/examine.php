    ...
    <div class="check" style="text-align: center">
        ...
        <div class="ctContent">  
            <div class="ctRecord">
                ...
                <div>
                    <div id="ctQuestion">A9. 這次互動過程中，我覺得我有具體的收穫：</div>
                    <div id="ctAnswer"><?=$_SESSION["ctRecord"]["A9"]?></div>
                </div>
                <?php }?>
                
                <?php if($_SESSION["ctRecord"]["B1"]==""){?>
                <div style="background-color: red; color: white; font-weight: bold">
                    <div id="ctQuestion">B. 這次互動後，我認為 <b><?=$_SESSION["ctRecord"]["id"][-2]?><?=$_SESSION["ctRecord"]["id"][-1]?>號<?=$_SESSION["ctRecord"]["name"]?></b> 的心情：</div>
                    <div id="ctAnswer">未填寫</div>
                </div>
                <?php }else{?>
                <div style="background-color: #C4C400">
