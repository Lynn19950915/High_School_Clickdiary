...
<header>
	<nav class="navbar navbar-expand-lg navbar-light fixed-top">
		...
		<div id="option" class="collapse navbar-collapse">
			<ul class="navbar-nav">
                <li class="nav-item"><a class="func nav-link" href="./aboutUs.php">關於我們</a></li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true">帳號管理</a>
                    <div class="dropdown-menu">
                        <a class="func dropdown-item" href="./passport.php">帳號總覽</a>
                        <a class="func dropdown-item" href="./myPoint.php">我的積分</a>
                    </div>
                </li>
                <li class="nav-item"><a class="func nav-link" href="./mission.php">任務專區</a></li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true">填答幫手</a>
                    <div class="dropdown-menu">
                        <a class="func dropdown-item" href="./SOP.php">填答手冊</a>
                        <a class="func dropdown-item" href="./FAQ.php">常見問題</a>
                    </div>
                </li>
                 <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true">查看</a>
                    <div class="dropdown-menu">
                        <a class="func dropdown-item" href="./Analysis.php">我的紀錄</a>
                    </div>
                </li>
            </ul>
