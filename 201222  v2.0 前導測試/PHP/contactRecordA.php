<?php
    ...
    if(isset($_POST["A4d"])){
        ...
        if($A4>23 or $A4<0 or floor($A4)-$A4!=0){
            ...
            echo "Early A4";             //b.輸入無效(過去時間)
        }else if($A4d==date("Y-m-d") and $A4>$hour){
            echo "Late A4";              //c.輸入無效(未來時間)
        }else{
            ...
            echo "PartA Success";       //d.暫存為變數，等B卷完成後一起寫入
        }
        exit();
    }
?>
...
<body>
    ...
    <div class="modal-content" style="font-size: 1em">
        ...
        <div class="modal-content" style="width: 100%; margin: 10px auto">
            ...
            <div class="modal-body">
                <fieldset data-role="controlgroup" data-type="horizontal">
                    ...
                    <label style="width: 20%"><input type="radio" name="A2" value="<?=$rs['name']?>以外的互動成員">自己以外的互動成員</label>
                    <label><input type="radio" name="A2" value="共同約定">共同約定</label>
                    <label><input type="radio" name="A2" value="偶然相遇">偶然相遇</label>
                    <label><input type="radio" name="A2" value="他人安排">他人安排</label>
                </fieldset>
            </div>
        </div>
        ...
        <div class="modal-content" style="width: 100%; margin: 0px auto">
            <div class="modal-header">
                <div class="modal-title"><b>A9. 這次接觸過程中，我覺得收穫大不大（與心情／情緒無關的具體收穫）：</b></div>
            </div>
            <div class="modal-body">
                <fieldset data-role="controlgroup" data-type="horizontal">
                    <label><input type="radio" name="A9" value="有損失／額外付出">有損失／額外付出</label>
