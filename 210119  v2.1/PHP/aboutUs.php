...
<body>
   ...
   <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">參與者同意書</h5>
        </div>
        <div class="modal-body">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            一、參與同學在研究期間於本平台執行各項活動後，可獲得點數獎勵，其積分公式如下：<br><br>
            <center>
                <b><span style="padding: 0.5%; background-color: #C4C400">總點數＝登入獎勵＋任務獎勵＋日記牆獎勵</span></b><br><br>
                參與同學當月所添加之點數，需滿足「當月有效參與」資格，方能獲得
            </center><br>
            
            二、獎勵項目細則<br>
            <div style="width: 94.5%; padding: 1% 1% 0% 1%; margin: 0px auto">
            <b>當月有效參與</b><br>
            同時完成「生活日記填寫」及「接觸紀錄新增」，視為一天有效日數，每月有效天數達 20 天（含）以上者，即判定為當月有效參與。<br>
            <span style="color: red">※注意：若未符合有效參與資格，當月將無法獲得任何點數。</span><br><br>
            ...
            ⭗班級團體加成：若當月有效參與同學達班級總人數 30％（含）以上者，該班有效參與同學之當月日記牆獎勵可獲得 10％ 加成；達 50％（含）以上者，獲得 20％ 加成。<br>
            </div><br>
            
            三、參與同學可於<a href="./myPoint.php">積分專區</a>查看個人之點數明細；攸關月結算資格的「當月有效天數」及「當月累計接觸筆數」等資訊，則可在<a href="./main.php">日記牆</a>上查看。所有之積分點數將於研究結束後統一進行核算，每 20 點獎勵點數可換得新台幣 1 元整。<br><br>
            ...
            五、為鼓勵參與，凡全程完成本研究活動者將獲得由中研院社會所開立之「學習時數認證」，共一學期四個月、計 80 小時。<br><br>
            
            <div style="font-size: 0.75em">
            ※參與同學參與本研究之同時，即視為同意接受本活動之規範，如有違反、或有任何以詐騙方式或其他足以破壞本活動之不法行徑，應負一切相關責任。<br>
            ※本研究活動有任何因電腦、網路、技術或其他不可歸責於單位之事由，而使參與同學所登錄之資料有所遺失、錯誤或無法辨識所導致資料無效之情況，本單位不負任何法律責任。為求公平公正，參與同學若以惡意之電腦程式或其他明顯違反活動公平性之方式，意圖混淆或影響結果者，一經單位察覺得立即取消參與同學之參與及補助資格，並保留法律追訴權力。<br>
