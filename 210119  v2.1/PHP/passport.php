<?php
    ...
    $sql2="SELECT COUNT(*) FROM `record` WHERE id= :v1 and MONTH(time)= :v2 and A7 IS NOT NULL and A8 IS NOT NULL and B IS NOT NULL";
    ...
    $sql3="SELECT DATE(time) FROM `record` WHERE id= :v1 and MONTH(time)= :v2 and A7 IS NOT NULL and A8 IS NOT NULL and B IS NOT NULL GROUP BY DATE(time)";
