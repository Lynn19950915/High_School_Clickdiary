                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(data=="PartB Success"){
                           ...
                           $.confirm({
                                title: "",
                                content: "你有部分內容未完成，請利用日記牆的「修改」功能進行補填，才算是完整記錄喔！",
                                buttons:{
                                    "OK": function(){
                                        window.location.href="./main.php";
                                    }
...
<body>
    ...
    <div class="modal-content">
        ...
        <div class="modal-content" style="width: 48%; margin: 1% auto">
            ...
            <div class="modal-body">
                <fieldset data-role="controlgroup" data-type="horizontal">
                    <label><input type="radio" name="<?=$r["recordId"]?>B1" value="很不好">很不好</label>
                    <label><input type="radio" name="<?=$r["recordId"]?>B1" value="有點不好">有點不好</label>
                    <label><input type="radio" name="<?=$r["recordId"]?>B1" value="普通">普通</label>
                    <label><input type="radio" name="<?=$r["recordId"]?>B1" value="有點好">有點好</label>
                    <label><input type="radio" name="<?=$r["recordId"]?>B1" value="很好">很好</label>
                    <label><input type="radio" name="<?=$r["recordId"]?>B1" value="不清楚">不清楚</label>
                </fieldset>
            </div>
        </div>
        ...
        <div class="modal-content" style="width: 48%; margin: 1% auto">
            ...
            <div class="modal-body">
                <fieldset data-role="controlgroup" data-type="horizontal">
                    <label><input type="radio" name="<?=$r["recordId"]?>B2" value="很不好">很不好</label>
                    <label><input type="radio" name="<?=$r["recordId"]?>B2" value="有點不好">有點不好</label>
                    <label><input type="radio" name="<?=$r["recordId"]?>B2" value="普通">普通</label>
                    <label><input type="radio" name="<?=$r["recordId"]?>B2" value="有點好">有點好</label>
                    <label><input type="radio" name="<?=$r["recordId"]?>B2" value="很好">很好</label>
                    <label><input type="radio" name="<?=$r["recordId"]?>B2" value="不清楚">不清楚</label>
                </fieldset>
            </div>
        </div>
        </div>
