<?php
    ...
    if(isset($_POST["00"])){
        ...
        if($A10_1!="0"){
            $sql101="UPDATE `lifediary` SET A10_1= :v1 WHERE id= :v2 and date= :v3";
        ...
        if($A11_1!="0"){
            $sql111="UPDATE `lifediary` SET A11_1= :v1 WHERE id= :v2 and date= :v3";
    ...
    <div class="check" style="text-align: center">
        ...
        <div class="ldContent">        
            ...
            <div class="ldRecord">
                ...
                <div>
                    <div id="ldQuestion">10. 我今天有沒有考試：</div>            
                    ...
                    <button id="ReviseA10" class="ldRevise">修改</button>                     
                </div>
                ...
                <div>
                    <div id="ldQuestion">11. 我今天有沒有拿到考試成績：</div>            
                    ...
                    <button id="ReviseA11" class="ldRevise">修改</button>                     
                </div>
