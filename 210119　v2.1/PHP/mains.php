<?php
    ...
    if(isset($_POST["cdate"])){
        ...
        if($cdate==""){
            ...
            $sql4="SELECT *, name FROM `record` LEFT JOIN `account` ON record.A0=account.id WHERE record.id= :v1 and (A7 IS NULL or A8 IS NULL or B IS NULL ) and A4d= :v2 ORDER BY A4 desc";
            ...
            $sql5="SELECT *, name FROM `record` LEFT JOIN `account` ON record.A0=account.id WHERE record.id= :v1 and (A7 IS NOT NULL and A8 IS NOT NULL and B IS NOT NULL) and A4d= :v2 ORDER BY A4 desc";
            ...
            $sql6="SELECT COUNT(*) FROM `record` WHERE id= :v1 and A4d= :v2 and A7 IS NOT NULL and A8 IS NOT NULL and B IS NOT NULL";
