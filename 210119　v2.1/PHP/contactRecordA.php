...
<body>
    ...
    <div class="modal-content" style="border: none">
        <h5 style="text-align: right"><b>記錄日期：
            <select class="std" name="A4d" style="width: 18%">
    ...
    <div class="modal-content" style="font-size: 1em">
        ...
        <div class="modal-content" style="width: 100%; margin: 10px auto">
            <div class="modal-header">
                <div class="modal-title"><b>A7. 這次互動後，我的心情變化：</b></div>
            </div>
            <div class="modal-body">
                <fieldset data-role="controlgroup" data-type="horizontal">
                    <label><input type="radio" name="A7" value="變得很差">變得很差</label>
                    <label><input type="radio" name="A7" value="變得有點差">變得有點差</label>
                    <label><input type="radio" name="A7" value="沒有改變">沒有改變</label>
                    <label><input type="radio" name="A7" value="變得有點好">變得有點好</label>
                    <label><input type="radio" name="A7" value="變得很好">變得很好</label>
                </fieldset>
            </div>
        </div>
        ...
        <div class="modal-content" style="width: 100%; margin: 0px auto">
            <div class="modal-header">
                <div class="modal-title"><b>A8. 這次互動過程中，我覺得我有具體的收穫（例如：知識、資訊、技術、錢財、點數等等）：</b></div>
            </div>
            <div class="modal-body">
                <fieldset data-role="controlgroup" data-type="horizontal">
                    <label><input type="radio" name="A8" value="有損失">有損失</label>
                    <label><input type="radio" name="A8" value="幾乎沒有收穫">幾乎沒有收穫</label>
                    <label><input type="radio" name="A8" value="有一點收穫">有一點收穫</label>
                    <label><input type="radio" name="A8" value="有很大收穫">有很大收穫</label>
                </fieldset>
            </div>
        </div>
    </div>
