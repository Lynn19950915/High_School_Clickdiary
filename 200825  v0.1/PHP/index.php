...
<body>
    ...
    <div class="wrapper">
        <div id="formContent">
            ...
            <div>
                <button id="btn_sign_in" class="btn fadeIn third" type="submit">登入</button>
            </div>
            </form>
        ...
        <div class="modal-dialog modal-lg">            
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>「高中生點日記」是中央研究院社會學研究所與統計科學研究所的點日記研究團隊所開發，用以紀錄在學期行進之間，高中生於其班級內之人際互動網絡、心情與健康行為等變化。本計畫名稱為「從自我核心網絡到完整網絡：部分及不一致接觸資料的推論設計」，已於 2020 年 2 月通過中央研究院倫理委員會之審查。
                    <br><br>
