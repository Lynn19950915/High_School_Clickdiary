...
<body>
    ...
    <div class="modal-content" style="font-size: 1em">
        ...
        <div class="modal-content" style="width: 100%; margin: 10px auto">
            <div class="modal-header">
                <div class="modal-title"><b>A4.這次互動的開始時間：（請輸入整數 0～23 點）</b></div>
            </div>
        ...
        <div class="modal-content" style="width: 100%; margin: 10px auto">
            ...
            <div class="modal-body" id="A5">
                <select class="std" name="A5">
                    ...
                    <option value="1-4分鐘">1-4分鐘</option>
                    <option value="5-14分鐘">5-14分鐘</option>
                    <option value="15-59分鐘">15-59分鐘</option>
                    <option value="1-4小時">1-4小時</option>
                    <option value="大於4小時">大於4小時</option>
                </select>
            </div>
        </div>
