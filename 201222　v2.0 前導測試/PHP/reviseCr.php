    ...
    if(isset($_POST["00"])){
        ...
        if($A4!=""){
            if($A4>23 or $A4<0 or floor($A4)-$A4!=0){
                echo "Wrong A4";
                exit();
            }else if($A4d!=date("Y-m-d") and $A4<4){
                echo "Early A4";
                exit();
    ...
    <script>
		$(document).ready(function(){
            ...
            $("#ReviseB1").on("click", function(event){
                event.preventDefault();
                $(".AB1").attr("hidden", true);
                $(".CB1").attr("hidden", false);
            })
            
            $("#ReviseB2").on("click", function(event){
                event.preventDefault();
                $(".AB2").attr("hidden", true);
                $(".CB2").attr("hidden", false);
            })
            ...
            $("#ctSubmit").on("click", function(event){
			    ...
			    $.ajax({ 
                    ...
                    success: function(data){
                        ...
                        }else if(data=="Early A4"){
                            $.alert({
                                title: "",
                                content: "無效答覆：此為前一天的時間範圍。"
                            })
    ...
    <div class="check" style="text-align: center">
        ...
        <div class="ctContent">       
            ...
            <div class="ctRecord">
                ...
                <div>
                    ...
                    <div id="ctChoice" class="CA2" hidden="true">
                        <select name="A2">
                            ...
                            <option value="<?=$rs['name']?>以外的互動成員">自己以外的互動成員</option>
                            <option value="共同約定">共同約定</option>
                            <option value="偶然相遇">偶然相遇</option>
                            <option value="他人安排">他人安排</option>
                        </select>
                    </div>
                ...
                <div style="background-color: #C4C400">
                    ...
                    <div id="ctChoice" class="CA3" hidden="true">
                        <select name="A3">
                            ...
                            <option value="傳文字或錄音">傳文字或錄音</option>
                        </select>
                    </div>
                ...
                <div style="background-color: #C4C400">
                    ...
                    <div id="ctChoice" class="CA6" hidden="true">
                        <select class="std" name="A6">
                            ...
                            <option value="其他互動成員住處／家裡">其他互動成員住處／家裡</option>
                ...
                <?php }else{?>
                <div style="background-color: #C4C400">
                    <div id="ctQuestion">A6. 這次互動，<?=$_SESSION["ctRecord"]["name"]?>在哪裡：</div>            
                    <div id="ctAnswer" class="AA6"><?=$_SESSION["ctRecord"]["A6"]?></div>
                    <div id="ctChoice" class="CA6" hidden="true">
                        <select class="std" name="A6">
                            <option value="0"></option>  
                ...
                <?php if($_SESSION["ctRecord"]["A9"]==""){?>
                <div style="background-color: red; color: white; font-weight: bold">
                    <div id="ctQuestion">A9. 這次接觸過程中，我覺得收穫大不大：</div>
                    <div id="ctAnswer" class="AA9">未填寫</div>
                    <div id="ctChoice" class="CA9" hidden="true">
                        <select class="std" name="A9">
                            <option value="0"></option>  
                            <option value="有損失／額外付出">有損失／額外付出</option>
