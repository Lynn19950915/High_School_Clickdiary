<?php
    ...
    if(isset($_POST["00"])){
        ...
        $l=0;
        while($k<count($j)){
            $B1=isset($_POST[$j[$k][0]["id"]."B1"])?$_POST[$j[$k][0]["id"]."B1"]:0;
            $B2=isset($_POST[$j[$k][0]["id"]."B2"])?$_POST[$j[$k][0]["id"]."B2"]:0;           
            
            if($B1!="0" and $B2!="0"){
                if(count($_SESSION["A0M"])==1){
                    $sql2="INSERT INTO `record` (id, time, `groups`, tagged, A0, A1, A2, A3, A4, A5, A6, A7, A8, A9, B1, B2) VALUES (:v1, CURTIME(), 0, 0, :A0, :A1, :A2, :A3, :A4, :A5, :A6, :A7, :A8, :A9, :B1, :B2)";
                    ...
                    $sql3="INSERT INTO `record` (id, time, `groups`, tagged, A0, A1, A2, A3, A4, A5, A6) VALUES(:v1, CURTIME(), 0, 1, :A0, :A1, :A2, :A3, :A4, :A5, :A6)";
                    ...
                    $sql4="INSERT INTO `record` (id, time, `groups`, tagged, A0, A1, A2, A3, A4, A5, A6, A7, A8, A9, B1, B2) VALUES (:v1, CURTIME(), 1, 0, :A0, :A1, :A2, :A3, :A4, :A5, :A6, :A7, :A8, :A9, :B1, :B2)";
                    ...
                    $sql5="INSERT INTO `record` (id, time, `groups`, tagged, A0, A1, A2, A3, A4, A5, A6) VALUES(:v1, CURTIME(), 1, 1, :A0, :A1, :A2, :A3, :A4, :A5, :A6)";
...
<body>
    ...
    <div class="modal-content">
        ...
        <div class="modal-content" style="width: 48%; margin: 1% auto">
            ...
            <div class="modal-body">
                <fieldset data-role="controlgroup" data-type="horizontal">
                    <label><input type="radio" name="<?=$r["id"]?>B1" value="很不好">很不好</label>
                    <label><input type="radio" name="<?=$r["id"]?>B1" value="有點不好">有點不好</label>
                    <label><input type="radio" name="<?=$r["id"]?>B1" value="普通">普通</label>
                    <label><input type="radio" name="<?=$r["id"]?>B1" value="有點好">有點好</label>
                    <label><input type="radio" name="<?=$r["id"]?>B1" value="很好">很好</label>
                    <label><input type="radio" name="<?=$r["id"]?>B1" value="不清楚">不清楚</label>
                </fieldset>
            </div>
        </div>
        ...
        <div class="modal-content" style="width: 48%; margin: 1% auto">
            ...
            <div class="modal-body">
                <fieldset data-role="controlgroup" data-type="horizontal">
                    <label><input type="radio" name="<?=$r["id"]?>B2" value="很不好">很不好</label>
                    <label><input type="radio" name="<?=$r["id"]?>B2" value="有點不好">有點不好</label>
                    <label><input type="radio" name="<?=$r["id"]?>B2" value="普通">普通</label>
                    <label><input type="radio" name="<?=$r["id"]?>B2" value="有點好">有點好</label>
                    <label><input type="radio" name="<?=$r["id"]?>B2" value="很好">很好</label>
                    <label><input type="radio" name="<?=$r["id"]?>B2" value="不清楚">不清楚</label>
                </fieldset>
            </div>
        </div>
        </div>
