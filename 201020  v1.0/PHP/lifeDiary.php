<?php
    ...
    if(isset($_POST["A1"])){
        ...
        //Key=id+today，若重複代表當天重填，覆蓋每一題的答案
        $sql2="INSERT INTO `lifediary` VALUES(:v1, CURTIME(), :A0, :A1, :A2, :A3, :A4, :A5, :A6, :A7, :A8, :A9, :A10, :A11)
              ON DUPLICATE KEY UPDATE time=CURTIME(), A1= :A1, A2= :A2, A3= :A3, A4= :A4, A5= :A5, A6= :A6, A7= :A7, A8= :A8, A9= :A9, A10= :A10, A11= :A11";
		...
		$(document).ready(function(){
            ...
            $.ajax({ 
                ...
                success: function(data){
                    ...
                    if(data=="Already Done LifeDiary"){
                        $.confirm({
                            title: "",
                            content: "你已完成今日生活日記，要重填嗎？",
                            buttons: {
                                "返回": function(){
...
<body>
    ...
    <div class="modal-content" style="border: none">
        <h5 style="text-align: right"><b>填答日期：<?=date("Y-m-d")?></b></h5>
    </div>
