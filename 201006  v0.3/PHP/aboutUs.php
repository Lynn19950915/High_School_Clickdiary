   ...
   <div class="modal-content">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <center>
                <b><span style="padding: 0.5%; background-color: #C4C400">總點數＝登入獎勵＋任務獎勵＋日記牆獎勵</span></b>
            </center><br>
            ...
            <b>日記牆獎勵</b><br>
            包含生活日記及接觸紀錄筆數。此點數為月度性結算，統一於次月 5 日進行點數發放。<br>
            </div><br>
            
            三、會員可於<a href="./myPoint.php">積分專區</a>查看個人之點數明細，所有之積分點數將於研究結束後統一進行核算，每 20 點獎勵點數可換得新台幣 1 元整。<br><br>
